...
DROP FUNCTION IF EXISTS search_purchase_orders(TEXT, TEXT); -- Add this line
...
DROP FUNCTION IF EXISTS toggle_po_status(UUID, TEXT); -- Add this line
...
DROP FUNCTION IF EXISTS create_new_po(TEXT, TEXT, TEXT, DATE, DATE, INT, NUMERIC); -- Add this line
